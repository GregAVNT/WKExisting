...
function bones_custom_admin_footer() {
	_e('<span id="footer-thankyou">Developed by <a href="http://www.fulcrumtech.net" target="_blank">FulcrumTech, LLC</a></span>.', 'bonestheme');
}
...
function load_admin_stuff() {
	...
	// admin scripts
	wp_register_script( 'custom_admin_script', get_template_directory_uri() . '/library/js/admin-scripts.min.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'custom_admin_script' );

	// admin styles
	wp_register_style( 'custom_admin_styles', get_stylesheet_directory_uri() . '/library/css/admin.css', array(), '1.0.0', 'all' );
